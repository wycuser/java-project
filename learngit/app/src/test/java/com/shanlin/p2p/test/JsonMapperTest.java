...
public class JsonMapperTest {
	...
	public void test (){
		...
		JavaType type = mapper.contructMapType(HashMap.class, String.class, String.class);
		String json = "{\"a\":\"1\",\"b\":1,\"c\":[1,2,3]}";
//		Map<String, String[]> map = mapper.fromJson(json, type);
		Map<String, Object> map = mapper.fromJson(json, HashMap.class);
		System.out.println(map.get("c").getClass());
		System.out.println(map);
		System.out.println(DigestUtils.md5Hex("20091113101533" + "1AB65E79FC4DA18F" + "{\"userId\":31,\"loginName\":\"zhengxin\",\"password\":\"zx6557428\"}"));
		System.out.println(Cryptos.aesEncrypt("{\"userId\":31,\"loginName\":\"zhengxin\",\"password\":\"zx6557428\"}", "1AB65E79FC4DA18F"));
		System.out.println(Cryptos.aesDecrypt("YAvwFK1qfiRHUp3H8og2sfSKVOVxCLNOslsYsWrERxANQT_6t6yjlpZM1V0rg8VMGm27Wxx-yiSRFOR1cfVdyw", "1AB65E79FC4DA18F"));
