package com.shanlin.framework.webservice.bbs;
 ...
 * 
 */
public class ClientClub extends PHPFunctions{

	public static boolean IN_UC = true;
	public static String UC_IP = "127.0.0.1";
	public static String UC_API = "http://localhost/discuz";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "111111";
	...
	static {
	    InputStream in = ClientClub.class.getClassLoader().getResourceAsStream("discuzclub.properties");
...
//		}
	...
	*/
	...
	public String uc_user_register(String $username, String $password, String $email, String $questionid, String $answer, String $mobile) {
		Map<String ,Object> args = new HashMap<String, Object>();
		args.put("username",$username);
		args.put("password",$password); 
		args.put("email",$email);
